#!/usr/bin/env node
// Re-record the golden tape hashes. The sim is TypeScript and the studio's
// toolchain for running it is vitest, so this runs the golden test with
// WRITE_GOLDEN=1: the test replays EVERY tape of EVERY game (games/*/tapes/),
// prints each OLD and NEW golden whole (never a prefix - a diff hidden past a
...
//
//   node toybox/harness/write-golden.mjs
