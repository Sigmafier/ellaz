...
describe("every stage mode on disk is completable by a scripted hero", () => {
  it("found the crypt and the fight's seven (the stage, the shelf's three, toybox-2, toybox-3 and the toybox boss level), so nothing below runs over an empty list", () => {
