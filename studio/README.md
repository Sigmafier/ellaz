...
| `games/<name>/` | a game on the engine: `data/`, `assets/`, `tapes/` (with the goldens beside), `page/`, and optionally `tournament/` history. Two today: `games/fight/` ([`games/fight/README.md`](games/fight/README.md) - its measured numbers) and `games/crypt/` ([`games/crypt/README.md`](games/crypt/README.md), 2026-09-12 - the first game built ON the engine; it cost the engine one data-gated rule and three painter kinds). Gate: `npm run assert:fight` walks every game. Verdict that picked Phaser: `docs/engine-tournament/fight-2026-09/` |
