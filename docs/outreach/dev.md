...
The number I care about most is the first visit: **89,983 bytes gzipped**, of a ceiling of
90,500 that fails the build. 517 bytes of room left. That figure is measured on the built
...
| 89,983 B gz first visit, 517 spare | `node scripts/assert-payload.mjs` on a clean tree at 1e219fe, 2026-08-18 |
