...
The number I care about most is the first visit: **90,108 bytes gzipped**, of a ceiling of
90,500 that fails the build. 392 bytes of room left. That figure is measured on the built
...
| 90,108 B gz first visit, 392 spare | `node scripts/assert-payload.mjs` on a clean tree at 1e219fe, 2026-08-18 |
