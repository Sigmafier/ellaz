...
**Every number in the letter is derived**: 90,356 bytes gzipped is the first visit
...
> על המכשיר עצמו. הטעינה הראשונה שוקלת 90,356 בתים דחוסים, פחות מתמונה בודדת בכתבה
