...
**Every number in the letter is derived**: 53,121 bytes gzipped is the first visit
...
> על המכשיר עצמו. הטעינה הראשונה שוקלת 53,121 בתים דחוסים, פחות מתמונה בודדת בכתבה
