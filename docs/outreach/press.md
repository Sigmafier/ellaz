...
**Every number in the letter is derived**: 90,232 bytes gzipped is the first visit
...
> על המכשיר עצמו. הטעינה הראשונה שוקלת 90,232 בתים דחוסים, פחות מתמונה בודדת בכתבה
