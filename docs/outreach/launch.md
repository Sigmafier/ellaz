...
- The first visit is 89,983 bytes gzipped and the build fails above 90,500.
...
| 89,983 B gz first visit | `scripts/assert-payload.mjs` on a clean tree at 1e219fe, 2026-08-18 |
