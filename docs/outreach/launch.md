...
- The first visit is 53,121 bytes gzipped and the build fails above 56,000.
...
| 53,121 B gz first visit | `scripts/assert-payload.mjs` on a clean tree at 1e219fe, 2026-08-18 |
