...
- The first visit is 90,108 bytes gzipped and the build fails above 90,500.
...
| 90,108 B gz first visit | `scripts/assert-payload.mjs` on a clean tree at 1e219fe, 2026-08-18 |
