...
export const AXES: Axis[] = [
  {
    ...
    arms: [
      { id: "oval", name: "Oval", blurb: "A card-room oval, wider than it is tall.", current: true },
      { id: "racetrack", name: "Racetrack", blurb: "Straight sides, fully round ends. The tournament shape." },
  ...
  },
  {
    ...
    arms: [
      { id: "index", name: "Corner index", blurb: "Rank and suit in two corners, a faded suit behind.", current: true },
      { id: "big", name: "Big rank", blurb: "The rank huge in the middle. Readable across a room." },
  ...
  },
  {
    ...
    arms: [
      { id: "std", name: "Standard", blurb: "Real playing-card proportions, softly rounded.", current: true },
      { id: "wide", name: "Wide", blurb: "A little squarer. More room for the rank." },
  ...
  },
  {
    ...
    arms: [
      { id: "plate", name: "Plate", blurb: "A rounded panel: animal, name, stack.", current: true },
      { id: "pill", name: "Pill", blurb: "The same panel, fully rounded. Lighter." },
  ...
  },
  {
    ...
    arms: [
      { id: "now", name: "As it is", blurb: "Today's timing.", current: true },
      { id: "slow", name: "Slower", blurb: "Half again as long. Easier to follow." },
      { id: "slower", name: "Much slower", blurb: "Double. Every card is an event." },
      { id: "snappy", name: "Snappier", blurb: "A quarter faster. For people who know the game." },
    ],
  },
];
