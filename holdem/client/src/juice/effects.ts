...
// Tuning constants inlined (ellaz reads these from its lab tuning store).
const SHIPPED = { shakePx: 6, shakeMs: 240, burstSpread: 190, confetti: 140 };
const tuning = () => SHIPPED;
const loadTuning = () => SHIPPED;
void loadTuning;
