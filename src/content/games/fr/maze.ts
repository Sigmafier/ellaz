...
export const mazeFr: GameCopy = {
  ...
  lede: "Une souris, 2 à 6 miettes, et un labyrinthe neuf à chaque fois. Le jeu connaît le trajet le plus court avant vous.",

  body: [
    "La souris part d'un coin. Il faut ramasser toutes les miettes. Le chemin se dessine au doigt. Ou aux flèches.",
    "Les 4 tailles font 5 sur 5 avec 2 miettes, 6 sur 6 avec 3, 7 sur 7 avec 4, et 10 sur 10 avec 6. L'ordre de ramassage est le vrai sujet : avec 4 miettes il y a 24 ordres possibles et 720 avec 6, et le jeu les essaie tous pour connaître le trajet le plus court avant que vous ne bougiez. Le record compte les labyrinthes parfaits d'affilée, donc ceux faits dans ce nombre de pas exactement.",
    ...
    "Le petit labyrinthe se boucle en 13,58 pas en moyenne et le moyen en 24,41. Le 10 sur 10, lui, est là pour ceux que le 7 sur 7 ne retient plus. Six miettes, 100 cases, et surtout un tout autre creusement : les trois autres tailles poussent un long couloir à la fois, celle-ci se ramifie de partout en même temps. Les impasses se multiplient. Résultat, 32,94 de ses cases sont des impasses contre 5,92 sur la taille en dessous. Le meilleur trajet y fait 52,78 pas, et la souris qui va toujours au plus proche ne le trouve que sur 33,0% des labyrinthes contre 68,6%.",
    "Les culs-de-sac sont volontairement rares chez les petits : 9 sur 10 sont rouverts sur le 5 sur 5, ce qui laisse 0,35 impasse par labyrinthe. Le 7 sur 7 en garde 5,92, et le 10 sur 10, creusé autrement, 32,94. Et sur 10,3% des petits labyrinthes, tous les ordres coûtent exactement pareil.",
  ...
  howToPlay: [
    ...
    },
    {
      ...
      body: "2 à 6 miettes selon la taille. L'ordre dans lequel vous les prenez décide de la longueur du trajet.",
    },
    {
  ...
  tips: [
    {
      ...
      body: "C'est le bon réflexe et c'est mesuré : il donne le trajet optimal sur 92,7% des petits labyrinthes, 68,6% des 7 sur 7 et 33,0% des 10 sur 10. Aucune autre règle simple n'approche ce résultat.",
    },
    {
      title: "N'utilisez pas l'ordre de lecture",
      body: "Ramasser de haut en bas et de gauche à droite semble naturel et ne marche que sur 44,6% des 7 sur 7 et 8,2% des 10 sur 10. C'est l'erreur la plus fréquente.",
    },
    {
  ...
  teaches: [
    ...
    },
    {
      ...
      body: "Reconnaître une impasse et faire demi-tour sans se décourager est une expérience utile. Le 7 sur 7 en offre 5,92 par partie, et le 10 sur 10 en garde 32,94.",
    },
  ],
  ...
  ages: [
    ...
    {
      title: "9 ans et plus",
      body: "Le 10 sur 10, six miettes et 720 ordres possibles. Un tiers de ses cent cases est une impasse.",
    },
    {
      title: "Adultes",
      body: "Le 10 sur 10, avec l'objectif du parcours parfait. Trouver le meilleur des 720 ordres possibles à l'oeil est un vrai petit problème.",
    },
  ],

  accessibility:
    "La souris se dirige au glissement de doigt ou aux flèches du clavier. Aucune case ne se touche, c'est une image et pas une cible. Elles font environ 49 pixels sur le 7 sur 7 et 34 sur le 10 sur 10, sur un écran de 390 pixels de large, et chacune est annoncée par son contenu, sa colonne et sa rangée, ce qui rend le labyrinthe utilisable au lecteur d'écran. Rien n'est chronométré. Les murs se voient par leur épaisseur et pas seulement par leur couleur.",
  ...
  faq: [
    ...
    },
    {
      ...
      a: "5 sur 5 avec 2 miettes, 6 sur 6 avec 3, 7 sur 7 avec 4, et 10 sur 10 avec 6 pour le niveau expert. Chaque labyrinthe est fabriqué au moment où il commence.",
    },
    {
      q: "Quelle est la meilleure façon de jouer ?",
      a: "Aller toujours vers la miette la plus proche. C'est le trajet optimal sur 92,7% des petits labyrinthes, 68,6% des 7 sur 7 et 33,0% des 10 sur 10.",
    },
    {
      q: "Combien de pas pour un bon parcours ?",
      a: "13,58 en moyenne sur le petit, 24,41 sur le moyen, 39,53 sur le 7 sur 7 et 52,78 sur le 10 sur 10.",
    },
    {
